...
const MysqlDSL = `CREATE TABLE IF NOT EXISTS %s (
 ...
 sink_id varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'sink_id',
 sink_type varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'sink_type',
 source varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'list、detail',
 url_md5 varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'md5 url ',
 url text COLLATE utf8mb4_unicode_ci COMMENT '唯一url',
 data json DEFAULT NULL COMMENT '差异字段（JSON格式）',
