...
const MysqlDSL = `CREATE TABLE IF NOT EXISTS %s (
 ...
 crawl_url varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'crawl_url',
 crawl_source varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'crawl_source',
